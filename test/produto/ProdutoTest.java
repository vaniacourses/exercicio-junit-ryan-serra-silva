...
public class ProdutoTest {
    ...
    @DisplayName("Deve alterar o nome do produto quando for executado um set na entidade")
    @Test
    void test1(){
        String expected= "DevOps HandBook";
        livro.setNome(expected);
        Assertions.assertEquals(expected, livro.getNome());
    }
    @DisplayName("Deve alterar o valor do produto quando for executado um set na entidade")
    @Test
    void test2(){
        double expected= 100;
        livro.setPreco(expected);
        Assertions.assertEquals(expected, livro.getPreco());
    }
